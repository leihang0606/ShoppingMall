...
<html>
  <head>
    ...
    <link href="files/商品套餐新增/styles.css" type="text/css" rel="stylesheet"/>
    ...
    <script src="files/商品套餐新增/data.js"></script>
  ...
  <body>
    ...
    <!-- 菜单 (动态面板) -->
    <div id="u56" class="ax_动态面板" data-label="菜单">
      <div id="u56_state0" class="panel_state" data-label="State1">
        ...
        <div id="u59" class="ax_图片">
          <img id="u59_img" class="img " src="images/系统登录默认页/u5.jpg"/>
          <!-- Unnamed () -->
        ...
        <div id="u65" class="ax_图片">
          <img id="u65_img" class="img " src="images/系统登录默认页/u5.jpg"/>
          <!-- Unnamed () -->
        ...
        <div id="u71" class="ax_图片">
          <img id="u71_img" class="img " src="images/系统登录默认页/u5.jpg"/>
          <!-- Unnamed () -->
        ...
        <div id="u77" class="ax_图片">
          <img id="u77_img" class="img " src="images/系统登录默认页/u5.jpg"/>
          <!-- Unnamed () -->
        ...
        <div id="u83" class="ax_图片">
          <img id="u83_img" class="img " src="images/系统登录默认页/u5.jpg"/>
          <!-- Unnamed () -->
        ...
        <div id="u89" class="ax_图片">
          <img id="u89_img" class="img " src="images/系统登录默认页/u5.jpg"/>
          <!-- Unnamed () -->
    ...
    <!-- alert (动态面板) -->
    <div id="u110" class="ax_动态面板" data-label="alert">
      <div id="u110_state0" class="panel_state" data-label="State1">

        <!-- Unnamed (形状) -->
        <div id="u111" class="ax_形状">
          <img id="u111_img" class="img " src="images/用户管理/u333.png"/>
          <!-- Unnamed () -->
        ...
        <div id="u113" class="ax_形状">
          <img id="u113_img" class="img " src="images/用户管理/u335.png"/>
          <!-- Unnamed () -->
        ...
        <div id="u117" class="ax_图片">
          <img id="u117_img" class="img " src="images/用户管理/u179.png"/>
          <!-- Unnamed () -->
        ...
        <div id="u119" class="ax_形状">
          <img id="u119_img" class="img " src="images/公告详细页面/u57.png"/>
          <!-- Unnamed () -->
        ...
        <div id="u121" class="ax_图片">
          <img id="u121_img" class="img " src="images/用户管理/u343.png"/>
          <!-- Unnamed () -->
        ...
        <div id="u125" class="ax_图片">
          <img id="u125_img" class="img " src="images/用户管理/u347.png"/>
          <!-- Unnamed () -->
    ...
    <!-- add (动态面板) -->
    <div id="u127" class="ax_动态面板" data-label="add">
      <div id="u127_state0" class="panel_state" data-label="State1">

        <!-- Unnamed (形状) -->
        <div id="u128" class="ax_形状">
          <img id="u128_img" class="img " src="images/角色管理/u107.png"/>
          <!-- Unnamed () -->
        ...
        <div id="u130" class="ax_形状">
          <img id="u130_img" class="img " src="images/角色管理/u109.png"/>
          <!-- Unnamed () -->
        ...
        <div id="u134" class="ax_图片">
          <img id="u134_img" class="img " src="images/用户管理/u179.png"/>
          <!-- Unnamed () -->
        ...
        <div id="u140" class="ax_图片">
          <img id="u140_img" class="img " src="images/角色管理/u126.png"/>
          <!-- Unnamed () -->
          <div id="u141" class="text"></div>
        </div>

        <!-- Unnamed (表格) -->
        <div id="u142" class="ax_表格">

          <!-- Unnamed (表格单元) -->
          <div id="u143" class="ax_表格单元">
            <img id="u143_img" class="img " src="images/用户管理/u54.png"/>
            <!-- Unnamed () -->
          ...
          <div id="u145" class="ax_表格单元">
            <img id="u145_img" class="img " src="images/用户管理/u56.png"/>
            <!-- Unnamed () -->
          ...
          <div id="u147" class="ax_表格单元">
            <img id="u147_img" class="img " src="images/商品管理/u64.png"/>
            <!-- Unnamed () -->
          ...
          <div id="u149" class="ax_表格单元">
            <img id="u149_img" class="img " src="images/商品套餐新增/u149.png"/>
            <!-- Unnamed () -->
          ...
          <div id="u151" class="ax_表格单元">
            <img id="u151_img" class="img " src="images/用户管理/u68.png"/>
            <!-- Unnamed () -->
          ...
          <div id="u153" class="ax_表格单元">
            <img id="u153_img" class="img " src="images/用户管理/u70.png"/>
            <!-- Unnamed () -->
          ...
          <div id="u155" class="ax_表格单元">
            <img id="u155_img" class="img " src="images/商品管理/u78.png"/>
            <!-- Unnamed () -->
          ...
          <div id="u157" class="ax_表格单元">
            <img id="u157_img" class="img " src="images/商品套餐新增/u157.png"/>
            <!-- Unnamed () -->
          ...
          <div id="u159" class="ax_表格单元">
            <img id="u159_img" class="img " src="images/用户管理/u82.png"/>
            <!-- Unnamed () -->
          ...
          <div id="u161" class="ax_表格单元">
            <img id="u161_img" class="img " src="images/用户管理/u84.png"/>
            <!-- Unnamed () -->
          ...
          <div id="u163" class="ax_表格单元">
            <img id="u163_img" class="img " src="images/商品管理/u92.png"/>
            <!-- Unnamed () -->
          ...
          <div id="u165" class="ax_表格单元">
            <img id="u165_img" class="img " src="images/商品套餐新增/u165.png"/>
            <!-- Unnamed () -->
          ...
          <div id="u167" class="ax_表格单元">
            <img id="u167_img" class="img " src="images/商品套餐新增/u167.png"/>
            <!-- Unnamed () -->
          ...
          <div id="u169" class="ax_表格单元">
            <img id="u169_img" class="img " src="images/商品套餐新增/u169.png"/>
            <!-- Unnamed () -->
          ...
          <div id="u171" class="ax_表格单元">
            <img id="u171_img" class="img " src="images/商品套餐新增/u171.png"/>
            <!-- Unnamed () -->
          ...
          <div id="u173" class="ax_表格单元">
            <img id="u173_img" class="img " src="images/商品套餐新增/u173.png"/>
            <!-- Unnamed () -->
        ...
        <div id="u175" class="ax_图片">
          <img id="u175_img" class="img " src="images/商品套餐新增/u175.png"/>
          <!-- Unnamed () -->
        ...
        <div id="u177" class="ax_图片">
          <img id="u177_img" class="img " src="images/商品套餐新增/u177.png"/>
          <!-- Unnamed () -->
        ...
        <div id="u182" class="ax_形状">
          <img id="u182_img" class="img " src="images/公告详细页面/u57.png"/>
          <!-- Unnamed () -->
        ...
        <!-- Unnamed (复选框) -->
        <div id="u184" class="ax_复选框">
          <label for="u184_input">
            <!-- Unnamed () -->
            <div id="u185" class="text"></div>
          </label>
          <input id="u184_input" type="checkbox" value="checkbox" checked/>
        </div>
        ...
        <div id="u190" class="ax_文本框_单行_">
          <input id="u190_input" type="text" value="1"/>
        </div>

        <!-- Unnamed (文本框(单行)) -->
        <div id="u191" class="ax_文本框_单行_">
          <input id="u191_input" type="text" value="1"/>
        </div>
    ...
    <div id="u205" class="ax_图片">
      <img id="u205_img" class="img " src="images/系统登录默认页/u121.png"/>
      <!-- Unnamed () -->
    ...
    <div id="u211" class="ax_图片">
      <img id="u211_img" class="img " src="images/系统登录默认页/u127.png"/>
      <!-- Unnamed () -->
    ...
    <div id="u213" class="ax_图片">
      <img id="u213_img" class="img " src="images/系统登录默认页/u129.png"/>
      <!-- Unnamed () -->

  			...
  			<!-- 最外面包的大div块 -->
	   		<div style="margin-top: 240px;margin-left: 240px;width: 600px;height: 40px;">
	   			...
	   			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	   				...
	   				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	   				<span style="font-size:25px;">修改角色</span>
	   			</div><br/><br/>
	   			
	   			<div style="margin-left: 200px;font-size: 18px">
	   					   <input value="${role.rid }" name="rid" type="hidden"/>
	   				角色编号：<input type="text" width="200px" name="rcode" value="${role.rcode }"/><br/><br/>
	   				角色名称：<input type="text" width="200px" name="role" value="${role.role }"/><br/><br/>

...
<html>
    ...
    <link href="files/商品套餐查看/styles.css" type="text/css" rel="stylesheet"/>
    ...
    <script src="files/商品套餐查看/data.js"></script>
  ...
  <body>
    ...
    <div id="u4" class="ax_文本">
      ...
      <div id="u5" class="text">
        <p><span>》 </span><span>查看</span><span>套餐</span></p>
      </div>
    </div>
    ...
    <div id="u22" class="ax_形状">
      <img id="u22_img" class="img " src="images/公告详细页面/u57.png"/>
      <!-- Unnamed () -->
    ...
    <div id="u26" class="ax_文本">
      ...
      <div id="u27" class="text">
        <p><span>每个套裝5瓶商品,自然之宝营养片 2 瓶,绿A天然螺旋藻片3瓶。</span></p>
      </div>
    </div>
    ...
    <div id="u40" class="ax_水平线">
      ...
      <img id="u40_line" class="img " src="images/商品套餐查看/u40_line.png" alt="u40_line"/>
    </div>

    <!-- 菜单 (动态面板) -->
    <div id="u41" class="ax_动态面板" data-label="菜单">
      <div id="u41_state0" class="panel_state" data-label="State1">
        ...
        <div id="u44" class="ax_图片">
          <img id="u44_img" class="img " src="images/系统登录默认页/u5.jpg"/>
          <!-- Unnamed () -->
        ...
        <div id="u50" class="ax_图片">
          <img id="u50_img" class="img " src="images/系统登录默认页/u5.jpg"/>
          <!-- Unnamed () -->
        ...
        <div id="u56" class="ax_图片">
          <img id="u56_img" class="img " src="images/系统登录默认页/u5.jpg"/>
          <!-- Unnamed () -->
        ...
        <div id="u62" class="ax_图片">
          <img id="u62_img" class="img " src="images/系统登录默认页/u5.jpg"/>
          <!-- Unnamed () -->
        ...
        <div id="u68" class="ax_图片">
          <img id="u68_img" class="img " src="images/系统登录默认页/u5.jpg"/>
          <!-- Unnamed () -->
        ...
        <div id="u74" class="ax_图片">
          <img id="u74_img" class="img " src="images/系统登录默认页/u5.jpg"/>
          <!-- Unnamed () -->
    ...
    <!-- 商品列表 (动态面板) -->
    <div id="u92" class="ax_动态面板" data-label="商品列表">
      <div id="u92_state0" class="panel_state" data-label="State1">

        <!-- 1 (形状) -->
        <div id="u93" class="ax_文本" data-label="1">
          <img id="u93_img" class="img " src="resources/images/transparent.gif"/>
          <!-- Unnamed () -->
          <div id="u94" class="text">
            <p><span>自然之宝营养片</span></p><p><span>&nbsp;</span></p>
          </div>
        </div>

        <!-- 2 (形状) -->
        <div id="u95" class="ax_文本" data-label="2">
    ...
    <div id="u113" class="ax_图片">
      <img id="u113_img" class="img " src="images/系统登录默认页/u121.png"/>
      <!-- Unnamed () -->
    ...
    <div id="u119" class="ax_图片">
      <img id="u119_img" class="img " src="images/系统登录默认页/u127.png"/>
      <!-- Unnamed () -->
    ...
    <div id="u121" class="ax_图片">
      <img id="u121_img" class="img " src="images/系统登录默认页/u129.png"/>
      <!-- Unnamed () -->

...
<c:if test="${lssr==null || lssu==null || lssc==null }">
	<c:redirect url="usercreate"></c:redirect>
</c:if>
<%
  			...
  			<!-- 最外面包的大div块 -->
	   		<div style="margin-top: 240px;margin-left: 240px">
	   			...
	   			<div style="float: left;">
	   				...
	   				用&nbsp;户&nbsp;名：<input type="text" name="nickname"/><br/><br/>
	   			...
	   			<div style="float: left;margin-left: 80px">
	   				...
	   				证件号码：<input type="text" name="cardcode"/><br/><br/>
	   				移动电话：<input type="text" name="tel"/><br/><br/>
	   			</div>

...
.splitterMask {
   ...
   z-index: 20000;
    ...
    <script type="text/javascript"><!--
        ...
        (function() {
            ...
            $(window).bind('load', function() {
                if(CHROME_5_LOCAL && !$('body').attr('pluginDetected')) {
                    window.location = 'resources/chrome/chrome.jsp';
                }
            });
        ...
        function getInitialUrl() {
            ...
            if(pageName.length > 0) return pageName + ".jsp";
            else {
        ...
        function initializeLogo() {
            if($axure.document.configuration.logoImagePath) {
                $('#interfaceControlFrameLogoImageContainer').jsp('<img id="logoImage" src="" />');
                $('#logoImage').attr('src', $axure.document.configuration.logoImagePath).load(function() { resizeContent(); });
                $('#interfaceControlFrameMinimizeContainer').css('background-color', '#FFFFFF');
            } else $('#interfaceControlFrameLogoImageContainer').hide();

            if ($axure.document.configuration.logoImageCaption) {
                $('#interfaceControlFrameLogoCaptionContainer').jsp($axure.document.configuration.logoImageCaption);
                $('#interfaceControlFrameMinimizeContainer').css('background-color', '#FFFFFF');
  ...
  <body  scroll="no">
    ...
    <div id="maximizePanelContainer">
        <iframe id="expandFrame" src="resources/expand.jsp" width="100%" height="100%" scrolling="no" allowtransparency="true" frameborder="0"></iframe>
    </div>
